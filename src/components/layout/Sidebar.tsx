                ...
                <div className="p-3 border-t border-white/5 space-y-2">
                    {user ? (
                        <button
                            onClick={signOut}
                            className={cn(
                                "w-full flex items-center p-2 rounded-lg hover:bg-red-500/10 text-slate-400 hover:text-red-400 transition-colors",
                        ...
                        <button
                            ...
                            className={cn(
                                "w-full flex items-center p-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white transition-colors shadow-lg shadow-blue-600/20",
